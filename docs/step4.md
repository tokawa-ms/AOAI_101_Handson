...
```txt
あなたは家族の料理担当です。家族の健康に配慮したバランスの良い献立メニューを考えてください。
献立メニューは、主菜、主食、汁物を必ず1品ずつ、さらに副菜を2品、合計5品提案してください。
献立メニューを作るのに必要な材料をリストアップしてください。
家にある食材をなるべく使い、足りない材料をリストアップしてください。
献立メニューの作り方をリストアップしてください。
どのように健康に配慮して献立メニューを提案したのかを記述してください。
...
すると、こんな感じで意図取りに副菜が 2 つになった結果が返ってくるはずです。<strike>（…が、たまにいうことを聞いてくれないこともあります）</strike>

![](./img/SKSkill002.png)

このように、Semantic Kernel における機能（関数）の定義のひとつの方法として、LLM に対して渡すプロンプトを自然言語で書くという方法もあることが、従来のアプリケーションの作り方との大きな違いとなります。こういった新しいアプリケーション開発の手法に、今のうちから慣れていただくことが、Semantic Kernel や LangChain といった、AI オーケストレーターを活用した、LLM を活用したアプリケーション開発のために役に立つと思います。

是非、プロンプトを色々と工夫してみて、他にも面白い結果が得られないか試してみてください！
